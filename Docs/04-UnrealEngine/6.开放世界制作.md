...
- 开放世界项目需要配备专业的引擎团队，以及更专业的制作人员（地编，策划，Gameplay...），在设计时充分考虑到世界分区的特性，甚至 **需要一名专业人员来监管世界分区的流送配置** 。

- 需要明白人的力量是有限的，因此在制作资产时尽可能采用程序化，在管控流程上尽可能使用自动化，寻找到合适的量化指标，来让制作流程变得可追溯，可迭代：
    - Houdini和UE5的PCG框架：
