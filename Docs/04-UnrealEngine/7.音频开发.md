...
这会使用到 [脉冲编码调制技术（Pulse Code Modulation，简称PCM）](https://baike.baidu.com/item/脉冲编码调制/5143788?fromModule=lemma_inlink) 来将声音的 **连续信号（Continuous Signal）** 转换为 **离散信号（Discrete Signal）**
...
![image-20240205181636978](Resources/image-20240205181636978.png)
