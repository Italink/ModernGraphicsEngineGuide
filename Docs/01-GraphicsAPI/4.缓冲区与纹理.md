...
在该教程的[04-BufferAndTexture](https://github.com/Italink/ModernGraphicsEngineGuide/blob/main/Source/1-GraphicsAPI/04-BufferAndTexture/Source/main.cpp)示例中，演示了如何使用 **Uniform Buffer** 和 **Texture**，你可以以它为参考，去实现一些有意思的东西：
